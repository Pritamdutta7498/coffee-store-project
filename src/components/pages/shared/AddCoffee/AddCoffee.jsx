...
const AddCoffee = () => {
  ...
  return (
    <div className="bg-[color:#F4F3F0] py-5 mb-20 ">
       <Link to="/" className="flex align-middle items-center gap-3  my-5 ml-40 font-semibold text-[color:#374151]"><BsArrowLeft/> Back to home</Link>
      ...
      <input type="submit" className="btn bg-[color:#DFA878] text-bold hover:bg-[color:#BA704F]  w-[61.3rem] mx-auto flex my-10" value="Add Coffee" />
      </form>
    </div>
  );
};
